...
include $(BUILDSYSDIR)/btypes/config_rci_pb_msgs.mk
...
FFLIBSUBDIR        = rci_pb_msgs
EXEC_BASEDIR       = $(abspath $(PREFIX))
EXEC_CONFDIR       = $(SYSCONFDIR)
EXEC_RESDIR        = $(EXEC_BASEDIR)/share/rci_pb_msgs
...
EXEC_INCDIR        = $(EXEC_BASEDIR)/include/rci_pb_msgs
EXEC_DFILEDIR      = $(EXEC_BASEDIR)/share/applications
EXEC_DOCDIR        = $(EXEC_BASEDIR)/share/doc/rci_pb_msgs-$(RCI_PB_MSGS_VERSION)
